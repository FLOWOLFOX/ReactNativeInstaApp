import { View, Text, SafeAreaView, ScrollView, StatusBar, Image, Dimensions, Platform } from 'react-native'
      ...
      {image ?
        ...
        <View
          style={{
            ...
            marginTop: Platform.OS === 'ios' ? 40 : 0,  // iPhone 15
          }}
        >
          ...
          >
            ...
            <Image
              source={image} style={{ width: '100%', height: '80%' }}
            />
            <View
              style={{
